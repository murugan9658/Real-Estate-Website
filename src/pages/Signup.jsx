    ...
    >
      ...
      >
        ...
        <motion.form onSubmit={handleSubmit} className="space-y-4" variants={containerVariants}>
          ...
          <motion.div variants={itemVariants}>
            <label className="block text-white text-lg mb-1">Re-Enter Password</label>
            <input
              type="password"
          ...
          >
            ...
            <motion.div className="text-center mt-4" variants={itemVariants} >
               <RouterLink
                to="/login"                
                className="inline-block align-baseline font-bold text-sm text-green-600 transition duration-300" >
                Already have an account? <span className='hover:text-white hover:underline pl-1 transition duration-300'>Sign in</span> 
               </RouterLink>
          </motion.div>
      </motion.div>
    </motion.div>

  ...
  return (
    <div className="bg-white shadow-md hover:shadow-2xl transition duration-300 mx-auto rounded-2xl overflow-hidden w-full max-w-sm">
      <div className="relative">
        ...
        <span className={`absolute bottom-2 left-2 z-10 text-xs font-bold px-2 py-1 rounded-full ${
      ...
      <div className="p-4 space-y-2">
        ...
        <div className="text-sm mt-2">
          <h3 className="font-semibold text-emerald-600 mb-1">Other Details</h3>

  ...
  return (
    <div className='w-full md:h-screen py-8 space-y-14 bg-green-100 flex flex-col'>   
        ...
        <div className='flex px-3  flex-col text-center items-center space-y-3 justify-center'>
          <h1 className='md:text-4xl text-3xl font-semibold text-stone-700 flex md:gap-2'><span className='hidden md:flex'><FcHome/></span>When to Use a Mortgage Calculator</h1>
        ...
        <div className='w-full flex flex-col space-y-3 px-14 md:px-44 '>
           <div className='flex flex-col space-y-4'>
            ...
            <div className='flex flex-col space-y-4'>
             <h1 className='md:text-3xl text-2xl font-semibold '>2. Loan comparison</h1>
            ...
            <div className='flex flex-col space-y-4'>
             <h1 className='md:text-3xl text-2xl font-semibold '> 3. Planning EMIs</h1>
              <ul className='pl-4 space-y-2 text-lg text-stone-700'>
            ...
            <div className='flex flex-col space-y-4'>
              <h1 className='md:text-3xl text-2xl font-semibold '>4. Investors / Real Estate Portals</h1>
              <ul className='pl-4 space-y-2 text-lg text-stone-700'>

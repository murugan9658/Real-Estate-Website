  ...
  return (
    <div className='w-full md:h-screen py-8 space-y-14 bg-green-100 flex flex-col'>   
        ...
        <div className='flex px-3  flex-col text-center items-center space-y-3 justify-center'>
          <h1 className='md:text-4xl text-3xl font-playfair font-semibold text-stone-700 flex md:gap-2'><span className='hidden md:flex'><FcHome/></span>When to Use a Mortgage Calculator</h1>
